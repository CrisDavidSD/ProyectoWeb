...
<body>
	...
	<form method="POST" action="${pageContext.request.contextPath}/GestionarUsuariosController?ruta=guardarExistente">
		...
		<label for="Rol">Rol (Administrador) :</label> 
		<input type="checkbox" name="Rol" id="Rol" value="true" ${persona.admin ? 'checked' : ''} />
		<br><br> 
